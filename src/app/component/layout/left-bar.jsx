                        ...
                        <li className='w-full' key={index} onClick={() => {
                            ...
                            <Tooltip placement="right">
                                <TooltipTrigger asChild>
                                    <Link href={item.href} className={` hover:bg-[linear-gradient(90deg,#007B58_0%,#138C6A_208.33%)] hover:border-[#FFFFFF29] border border-transparent h-12 rounded-xl w-full flex justify-start gap-3 px-4 items-center mb-4 `}>
                                        <span>
                                            {item.icon}
                                        </span>
