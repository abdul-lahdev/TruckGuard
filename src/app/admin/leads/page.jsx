...
export default function Page() {
    ...
    return (
        <div className='pt-5 h-full'>
            ...
            {
                newLead ? <div className='grid grid-cols-[335px_1fr] gap-4'>
                    ...
                    <div className='bg-white rounded-3xl border p-4'>
                        <form onSubmit={(e) => { e.preventDefault(); /* handle save */ }}>
                            <div className='flex justify-between items-center mb-6'>
                                <div className='flex items-center gap-3 cursor-pointer' onClick={() => dispatch({ type: 'setNewLead', payload: !newLead })}>
                                    <span>
      ...
      "
                ...
                </div> : <KanvanCard newLead={newLead} dispatch={dispatch} />
